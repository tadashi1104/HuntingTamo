...
class GameSceneA: UIViewController, CLLocationManagerDelegate, SCNPhysicsContactDelegate, NADInterstitialDelegate {
    //ゲーム共通クラス
    ...
    override func viewDidLoad() {
        ...
        setCamera()
        //怒
        settingJ("怒", colorA: UIColor.redColor(), colorB: UIColor.brownColor(), vector3: SCNVector3(x: 0, y: 0, z: -100))
        //キャラの設定
        setChara()
        //ラベルのセット
        setLabel()
    ...
    func completeStage() {
        ...
        defaults.setObject(1, forKey: "A_COMP")
    }
