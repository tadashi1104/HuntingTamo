...
class GameScoreAttack: UIViewController, CLLocationManagerDelegate, SCNPhysicsContactDelegate, NADInterstitialDelegate {
    //ゲーム共通クラス
    ...
    var interval = 2.0
    //タイマーラベル
    let timerLabel: UILabel = UILabel(frame: CGRectMake(0,0,200,50))
    var timerCount = 60
    ...
    override func viewDidLoad() {
        ...
        setCamera()
        //喜
        settingJ("喜",  colorA: UIColor.yellowColor(), colorB: UIColor.orangeColor(), vector3: SCNVector3(x: -24, y: 2, z: -100))
        //怒
        settingJ("怒",  colorA: UIColor.redColor(), colorB: UIColor.brownColor(), vector3: SCNVector3(x: -8, y: 2, z: -100))
        //哀
        settingJ("哀",  colorA: UIColor.blueColor(), colorB: UIColor.purpleColor(), vector3: SCNVector3(x: 8, y: 2, z: -100))
        //楽
        settingJ("楽", colorA: UIColor.greenColor(), colorB: UIColor.cyanColor(), vector3: SCNVector3(x: 24, y: 2, z: -100))
        //愛
        settingJ("愛", colorA: UIColor(red: 1.0, green: 0.2, blue: 0.4, alpha: 1.0), colorB: UIColor(red: 1.0, green: 0.753, blue: 0.796, alpha: 1.0), vector3: SCNVector3(x: 0, y: -2, z: -70))
    ...
    func timerStart() {
        ...
        //タイマーを生成
        self.timer2 = NSTimer.scheduledTimerWithTimeInterval(1, target: self, selector: "setLife", userInfo: nil, repeats: true)
    }
    ...
    func createTamo() {
        ...
        switch(random){
        case 0:
            imageRight.diffuse.contents = UIImage(named: "J_Tamo_Right")
            imageLeft.diffuse.contents = UIImage(named: "J_Tamo_Left")
            imageTop.diffuse.contents = UIImage(named: "J_Tamo_Top")
            imageBottom.diffuse.contents = UIImage(named: "J_Tamo_Bottom")
            imageFront.diffuse.contents = UIImage(named: "J_Tamo_Front")
            imageBack.diffuse.contents = UIImage(named: "J_Tamo_Back")
        case 1:
            imageRight.diffuse.contents = UIImage(named: "A_Tamo_Right")
            imageLeft.diffuse.contents = UIImage(named: "A_Tamo_Left")
            imageTop.diffuse.contents = UIImage(named: "A_Tamo_Top")
            imageBottom.diffuse.contents = UIImage(named: "A_Tamo_Bottom")
            imageFront.diffuse.contents = UIImage(named: "A_Tamo_Front")
            imageBack.diffuse.contents = UIImage(named: "A_Tamo_Back")
        case 2:
        ...
        case 3:
            imageRight.diffuse.contents = UIImage(named: "H_Tamo_Right")
            imageLeft.diffuse.contents = UIImage(named: "H_Tamo_Left")
            imageTop.diffuse.contents = UIImage(named: "H_Tamo_Top")
            imageBottom.diffuse.contents = UIImage(named: "H_Tamo_Bottom")
            imageFront.diffuse.contents = UIImage(named: "H_Tamo_Front")
            imageBack.diffuse.contents = UIImage(named: "H_Tamo_Back")
        case 5:
            imageRight.diffuse.contents = UIImage(named: "L_Tamo_Right")
            imageLeft.diffuse.contents = UIImage(named: "L_Tamo_Left")
            imageTop.diffuse.contents = UIImage(named: "L_Tamo_Top")
            imageBottom.diffuse.contents = UIImage(named: "L_Tamo_Bottom")
            imageFront.diffuse.contents = UIImage(named: "L_Tamo_Front")
            imageBack.diffuse.contents = UIImage(named: "L_Tamo_Back")
        break default:
            return
        }
    ...
    func setLabel() {
        ...
        // 配置する座標を設定する.
        timerLabel.layer.position = CGPoint(x: self.view.bounds.width * 0.5, y: 30)
        // FontSize
    ...
    override func touchesBegan(touches: NSSet, withEvent event: UIEvent) {
        ...
        if flgDeth == true || compLabel.text == "Time Up!" {
            sleep(1)
            stageChange()
            return
        }
    ...
    func completeStage() {
        ...
        defaults.setObject(1, forKey: "GAME_COMP")
    }
