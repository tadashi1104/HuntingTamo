...
class GameSceneH: UIViewController, CLLocationManagerDelegate, SCNPhysicsContactDelegate, NADInterstitialDelegate {
    //ゲーム共通クラス
    ...
    override func viewDidLoad() {
        ...
        setCamera()
        //楽
        settingJ("楽", colorA: UIColor.greenColor(), colorB: UIColor.cyanColor(), vector3: SCNVector3(x: 0, y: 0, z: -100))
        //キャラの設定
        setChara()
        //ラベルのセット
        setLabel()
    ...
    func completeStage() {
        ...
        defaults.setObject(1, forKey: "H_COMP")
    }
