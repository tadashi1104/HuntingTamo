...
class GameSceneLove: UIViewController, CLLocationManagerDelegate, SCNPhysicsContactDelegate, NADInterstitialDelegate {
    //ゲーム共通クラス
    ...
    override func viewDidLoad() {
        ...
        setCamera()
        //愛
        settingJ("愛", colorA: UIColor(red: 1.0, green: 0.2, blue: 0.4, alpha: 1.0), colorB: UIColor(red: 1.0, green: 0.753, blue: 0.796, alpha: 1.0), vector3: SCNVector3(x: 0, y: 0, z: -100))
        //キャラの設定
        setChara()
        //ラベルのセット
        setLabel()
                                            ...
                                            goLabel.text = "1"
                                                ...
                                                UIView.animateWithDuration(0.5, delay: 1.0, options: [], animations: {() -> Void in
                                                    goLabel.alpha = 0.0
                                                        ...
                                                        UIView.animateWithDuration(0.5, delay: 1.0, options: [], animations: {() -> Void in
                                                            goLabel.alpha = 1.0
                                                            goLabel.text = NSLocalizedString("FinalMessage", comment: "comment")
                                                            }, completion: {(Bool) -> Void in
                                                                UIView.animateWithDuration(0.5, delay: 1.0, options: [], animations: {() -> Void in
                                                                    goLabel.alpha = 0.0
                                                                    self.timerStart()
